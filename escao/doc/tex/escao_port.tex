...
\begin{document}
  ...
  \author{
    ...
    \small{Pontif{\'\i}cia Universidade Cat{\'o}lica do Rio Grande do Sul}\\
    \small{E-mail: \texttt{filipi@em.pucrs.br}}
    \footnote{Correspond{\^e}ncias podem ser endere{\c c}adas {\`a} este autor para:
    Pontif{\'\i}cia Universidade Cat{\'o}lica do Rio Grande do Sul, Depto. de
    Engenharia Mec{\^a}nica e Mecatr{\^o}nica. Av. Ipiranga, 6681. Pr{\'e}dio
  ...
  \and
    ...
    \small{Universidade do Vale do Rio dos Sinos}\\
  ...
  \section{Introdu{\c c}{\~a}o}
    ...
    \hspace{.25 cm}
    O objetivo desta pesquisa {\'e} apresentar a l{\'o}gica \textbf{Es{\c c}{\~a}o(n~m~p)}
    A l{\'o}gica \textbf{Es{\c c}{\~a}o(n~m~p)} vem trazer os computadores de quinta
    gera{\c c}{\~a}o, ofuscando os atualmente chamados computadores \textit{Von 
    Neumann’s Bottleneck} from the current computers. Enable, also, a
    deterministic  perception of the variable inputs and functioning in a 
    real time. From this datas, the theoretical aspects of this new
    computation was investigated and tried to use it in a lot of systems to
     confirm its functioning and evaluate the advantages against the
    conventional controllers.

    The significance of this work is contribution for a search to eliminate
    the Von Neumann bottleneck from the present computational architecture. It
    deals by putting in practical the ``General Model for a Digital System'',
    ...
    information is obliged to pass by a centralized stage which is gonna deal,
    arrange and decide the destiny that the program information flow must to
    take.

    Happens that the advanced technology, like computers architecture and
